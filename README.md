...
2. ✅ **Install base tools**: `aria2`, `btop`, `tree`, `ncdu`, `gdal-bin`, `libgdal-dev`, `git`, `jq`, `ruby`, `tmux`, `vim`
...
11. Remove base packages (`aria2`, `btop`, `tree`, `ncdu`, `gdal-bin`, `libgdal-dev`, `jq`, `ruby`, `tmux`, `vim`)
